...
Probability & Statistics I & II, Biostatistics, Data Analysis (topics including descriptive & inferential statistics, variable types (qualitative, quantitative), distribution properties, discrete & continuous types, R functions, probability distributions, Hypothesis testing using using critical value (Probability, F Statistics, Coefficient) using ANOVA, T-test, correlation, chi-Square test, regression, etc.). Regression (linear, multiple, logistic), Probability distributions (Discrete, Binomial, Poisson, Continuous Uniform, Chi-squared, Student-t, Fisher,)  Exponential, Normal, Chi-Square), Hypothesis testing using using critical value (Probability, F Statistics, Coefficient) Analysis of Variance (ANOVA), data wrangling, Post Hoc Test. Data wrangling and handling. Data Visualization (BoxPlots, Scatter Plots).
...
selected function(mlv, library, ggscatter, cor.test, mean, mode, Median, table, read.csv, chisq.test, dbinom, pbinom, ppois, runif, qchisq, qt, qf, pexp, runif, aov, summary, TukeyHSD, rnorm, seq, plot, lines, t.test, dbinom, levels, ggplot, glimpse(df)). Student T test distribution plot: Student t dis.png
